%global packname  targetscan.Mm.eg.db
...
%description
TargetScan miRNA target predictions for mouse assembled using data from
...
%defattr(-, root, root, -)
%changelog
* Fri Dec 09 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 0.4.0-1
