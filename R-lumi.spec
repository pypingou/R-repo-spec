...
Requires:         R-methylumi R-Biobase R-nleqslv 

BuildRequires:    R-devel tex(latex) R-methylumi R-Biobase R-nleqslv 
...
also includes the functions of processing Illumina methylation
microarrays, especially Illumina Infinium methylation microarrays.
...
%defattr(-, root, root, -)
%changelog
* Thu Nov 24 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 2.6.0-1
