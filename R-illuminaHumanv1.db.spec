%global packname  illuminaHumanv1.db
...
Version:          1.12.1
Release:          1%{?dist}
Summary:          Illumina HumanWG6v1 annotation data (chip illuminaHumanv1)
...
%description
Illumina HumanWG6v1 annotation data (chip illuminaHumanv1) assembled using
