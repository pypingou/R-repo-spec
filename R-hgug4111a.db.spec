...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Agilent Human 1B annotation data (chip hgug4111a)
...
%description
Agilent Human 1B annotation data (chip hgug4111a) assembled using data
