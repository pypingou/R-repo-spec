%global packname  POCRCannotation.db
...
Version:          2.6.3
Release:          1%{?dist}
Summary:          A package containing metadata for POCRC arrays
...
%description
A package containing metadata for POCRC arrays assembled using data from
public repositories
