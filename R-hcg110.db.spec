...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Affymetrix Human Cancer G110 Array annotation data (chip hcg110)
...
%description
Affymetrix Human Cancer G110 Array annotation data (chip hcg110) assembled
