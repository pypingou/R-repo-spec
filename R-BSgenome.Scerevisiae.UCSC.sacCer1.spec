%global packname  BSgenome.Scerevisiae.UCSC.sacCer1
...
%description
Saccharomyces cerevisiae (Yeast) full genome as provided by UCSC (sacCer1,
Oct. 2003) and stored in Biostrings objects.
