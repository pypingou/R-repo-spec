...
Requires:         R-car R-clv R-cluster R-class R-rpart R-nnet R-rgl R-Rcmdr 


BuildRequires:    R-devel tex(latex) R-car R-clv R-cluster R-class R-rpart R-nnet R-rgl R-Rcmdr



%description
Underlying support functions for RcmdrPlugin.BCA and a companion to the
book Customer and Business Analytics: A Hands-on Approach
