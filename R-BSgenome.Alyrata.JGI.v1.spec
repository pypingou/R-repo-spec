%global packname  BSgenome.Alyrata.JGI.v1
...
%description
Arabidopsis lyrata 8x Release [project ID 4002920] as provided by JGI (
snapshot from March 24, 2011) and stored in Biostrings objects.
