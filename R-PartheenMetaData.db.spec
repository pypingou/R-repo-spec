%global packname  PartheenMetaData.db
...
Version:          2.6.3
Release:          1%{?dist}
Summary:          PartheenMetaData http://swegene.onk.lu.se Annotation Data (PartheenMetaData)
...
%description
PartheenMetaData http://swegene.onk.lu.se Annotation Data
(PartheenMetaData) assembled using data from public repositories
