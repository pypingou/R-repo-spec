...
%files
%defattr(-, root, root, -)
%doc %{rlibdir}/robustreg/html
%doc %{rlibdir}/robustreg/DESCRIPTION
%{rlibdir}/robustreg/Meta
%{rlibdir}/robustreg/NAMESPACE
%{rlibdir}/robustreg/help
%{rlibdir}/robustreg/INDEX
%{rlibdir}/robustreg/R
