...
%files
%defattr(-, root, root, -)
%doc %{rlibdir}/functional/html
%doc %{rlibdir}/functional/DESCRIPTION
%{rlibdir}/functional/NAMESPACE
%{rlibdir}/functional/help
%{rlibdir}/functional/R
%{rlibdir}/functional/INDEX
%{rlibdir}/functional/Meta
