...
Version:          2.11.0
Release:          1%{?dist}
Summary:          GE CodeLink ADME Rat 16-Assay Bioarray annotation data (chip adme16cod)
...
%description
GE CodeLink ADME Rat 16-Assay Bioarray annotation data (chip adme16cod)
...
%defattr(-, root, root, -)
%changelog
* Mon Dec 12 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 2.11.0-1
