...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Agilent Human 1A (V2) annotation data (chip hgug4110b)
...
%description
Agilent Human 1A (V2) annotation data (chip hgug4110b) assembled using
