...
BuildRequires:    R-devel tex(latex) R-lattice R-grid 

%description
High-featured panel functions for bwplot and xyplot, various plot
management helpers, some other utility functions
