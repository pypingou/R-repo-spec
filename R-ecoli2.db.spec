...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Affymetrix E. coli Genome 2.0 Array annotation data (chip ecoli2)
...
Requires:         R-methods R-AnnotationDbi R-org.EcK12.eg.db 
Requires:         R-methods R-AnnotationDbi 

BuildRequires:    R-devel tex(latex) R-methods R-AnnotationDbi R-org.EcK12.eg.db
