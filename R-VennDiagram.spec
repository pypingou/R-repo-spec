...
%files
%defattr(-, root, root, -)
%doc %{rlibdir}/VennDiagram/DESCRIPTION
%doc %{rlibdir}/VennDiagram/html
%{rlibdir}/VennDiagram/R
%{rlibdir}/VennDiagram/NAMESPACE
%{rlibdir}/VennDiagram/help
%{rlibdir}/VennDiagram/INDEX
%{rlibdir}/VennDiagram/Meta
