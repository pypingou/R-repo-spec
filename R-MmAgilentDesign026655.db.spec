%global packname  MmAgilentDesign026655.db
...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Agilent Chips that use Agilent design number 026655 annotation data (chip MmAgilentDesign026655)
...
MmAgilentDesign026655) assembled using data from public repositories
