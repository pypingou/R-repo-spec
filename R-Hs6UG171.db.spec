...
Version:          2.6.3
Release:          1%{?dist}
Summary:          A package containing metadata for Hs6UG171 arrays
...
%description
A package containing metadata for Hs6UG171 arrays assembled using data
