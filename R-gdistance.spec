...
Requires:         R-raster R-igraph R-Matrix R-methods R-sp 

BuildRequires:    R-devel tex(latex) R-raster R-igraph R-Matrix R-methods R-sp 
...
%defattr(-, root, root, -)
%changelog
* Fri Nov 25 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 1.1.2-1
