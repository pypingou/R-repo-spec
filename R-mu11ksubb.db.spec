...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Affymetrix Murine 11K Set annotation data (chip mu11ksubb)
...
%description
Affymetrix Murine 11K Set annotation data (chip mu11ksubb) assembled using
