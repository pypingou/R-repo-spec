...
%description
A set of annotation maps describing the entire Disease Ontology assembled
using data from DO
...
%defattr(-, root, root, -)
%changelog
* Sat Dec 10 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 2.3.0-1
