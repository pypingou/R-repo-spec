...
Version:          2011.11.1
Release:          1%{?dist}
Summary:          Time Series Database Interface extension to connect to spreadsheets
...
Requires:         R-methods R-DBI R-TSdbi R-tframe R-tframePlus R-gdata R-zoo 
Requires:         R-methods R-DBI R-TSdbi 

BuildRequires:    R-devel tex(latex) R-methods R-DBI R-TSdbi R-tframe R-tframePlus R-gdata R-zoo
