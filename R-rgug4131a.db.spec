...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Agilent "Rat Genome, Whole" annotation data (chip rgug4131a)
...
%description
Agilent "Rat Genome,  Whole" annotation data (chip rgug4131a) assembled
