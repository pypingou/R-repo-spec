...
Version:          2.11.0
Release:          1%{?dist}
Summary:          GE CodeLink Mouse Inflammation 16 Bioarray annotation data (chip mi16cod)
...
%description
GE CodeLink Mouse Inflammation 16 Bioarray annotation data (chip mi16cod)
