%global packname  illuminaMousev1.db
...
Version:          1.12.1
Release:          1%{?dist}
Summary:          Illumina MouseWG6v1 annotation data (chip illuminaMousev1)
...
%description
Illumina MouseWG6v1 annotation data (chip illuminaMousev1) assembled using
