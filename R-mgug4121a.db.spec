...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Agilent Mouse annotation data (chip mgug4121a)
...
%description
Agilent Mouse annotation data (chip mgug4121a) assembled using data from
public repositories
