...
Version:          2.11.0
Release:          1%{?dist}
Summary:          GE CodeLink Human Inflammation 16 Bioarray annotation data (chip hi16cod)
...
%description
GE CodeLink Human Inflammation 16 Bioarray annotation data (chip hi16cod)
