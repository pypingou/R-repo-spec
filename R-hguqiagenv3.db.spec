%global packname  hguqiagenv3.db
...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Qiagen Qiagen V3.0 oligo set annotation data (chip hguqiagenv3)
...
%description
Qiagen Qiagen V3.0 oligo set annotation data (chip hguqiagenv3) assembled
