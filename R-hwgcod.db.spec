...
Version:          2.11.0
Release:          1%{?dist}
Summary:          GE CodeLink Human Whole Genome Bioarray (~55 000 human genes) annotation data (chip hwgcod)
...
%description
GE CodeLink Human Whole Genome Bioarray (~55 000 human genes) annotation
