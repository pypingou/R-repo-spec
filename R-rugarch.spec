...
Requires:         R-Rcpp R-RcppArmadillo R-methods R-numDeriv R-chron R-Rsolnp 


BuildRequires:    R-devel tex(latex) R-Rcpp R-RcppArmadillo R-methods R-numDeriv R-chron R-Rsolnp



%description
ARFIMA, in-mean, external regressors and various GARCH flavours, with
