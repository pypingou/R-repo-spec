%global packname  pd.ragene.1.0.st.v1
...
Version:          3.4.0
Release:          1%{?dist}
Summary:          Platform Design Info for Affymetrix RaGene-1_0-st-v1
...
%defattr(-, root, root, -)
%changelog
* Mon Dec 12 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 3.4.0-1
