...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Affymetrix Human Genome U133 Set annotation data (chip hgu133b)
...
%description
Affymetrix Human Genome U133 Set annotation data (chip hgu133b) assembled
