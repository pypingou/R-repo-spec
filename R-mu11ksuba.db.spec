...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Affymetrix Murine 11K Set annotation data (chip mu11ksuba)
...
%description
Affymetrix Murine 11K Set annotation data (chip mu11ksuba) assembled using
