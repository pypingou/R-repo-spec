...
Version:          2.11.0
Release:          1%{?dist}
Summary:          GE CodeLink UniSet Mouse 20k I Bioarray annotation data (chip m20kcod)
...
%description
GE CodeLink UniSet Mouse 20k I Bioarray annotation data (chip m20kcod)
