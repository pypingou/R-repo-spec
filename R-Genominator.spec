...
Requires:         R-methods R-RSQLite R-DBI R-IRanges R-GenomeGraphs 
Requires:         R-graphics R-stats R-utils 

BuildRequires:    R-devel tex(latex) R-methods R-RSQLite R-DBI R-IRanges R-GenomeGraphs
