%global packname  illuminaMousev1p1.db
...
%description
Illumina MouseWG6v1p1 annotation data (chip illuminaMousev1p1) assembled
...
%defattr(-, root, root, -)
%changelog
* Mon Dec 12 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 1.12.1-1
