...
%files
%defattr(-, root, root, -)
%doc %{rlibdir}/QuantPsyc/html
%doc %{rlibdir}/QuantPsyc/DESCRIPTION
%{rlibdir}/QuantPsyc/NAMESPACE
%{rlibdir}/QuantPsyc/INDEX
%{rlibdir}/QuantPsyc/Meta
%{rlibdir}/QuantPsyc/data
%{rlibdir}/QuantPsyc/R
%{rlibdir}/QuantPsyc/help
