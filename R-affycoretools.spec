...
Requires:         R-affy R-Biobase R-GO.db R-KEGG.db 

BuildRequires:    R-devel tex(latex) R-affy R-Biobase R-GO.db R-KEGG.db 
...
%defattr(-, root, root, -)
%changelog
* Thu Dec 01 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 1.26.0-1
