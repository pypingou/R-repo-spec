...
Source0:          http://cran.r-project.org/src/contrib/%{packname}_1.10-2.tar.gz
BuildRoot:        %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)

Requires:         R-rgl R-tensorA R-robustbase R-energy 


BuildRequires:    R-devel tex(latex) R-rgl R-tensorA R-robustbase R-energy
...
%defattr(-, root, root, -)
%changelog
* Thu Dec 08 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 1.10.2-1
