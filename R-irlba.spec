...
Version:          1.0.1
Release:          1%{?dist}
Summary:          Fast partial SVD by implicitly-restarted Lanczos bidiagonalization
...
%files
%defattr(-, root, root, -)
%doc %{rlibdir}/irlba/DESCRIPTION
%doc %{rlibdir}/irlba/NEWS
%doc %{rlibdir}/irlba/doc
%doc %{rlibdir}/irlba/html
%{rlibdir}/irlba/R
%{rlibdir}/irlba/INDEX
%{rlibdir}/irlba/Meta
%{rlibdir}/irlba/NAMESPACE
%{rlibdir}/irlba/help
