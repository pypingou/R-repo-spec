...
Version:          2.6.3
Release:          1%{?dist}
Summary:          FHCRC Genomics Shared Resource HuO22 Annotation Data (HuO22)
...
%description
FHCRC Genomics Shared Resource HuO22 Annotation Data (HuO22) assembled
