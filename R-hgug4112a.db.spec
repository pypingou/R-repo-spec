...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Agilent "Human Genome, Whole" annotation data (chip hgug4112a)
...
%description
Agilent "Human Genome,  Whole" annotation data (chip hgug4112a) assembled
