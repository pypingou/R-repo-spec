...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Affymetrix Murine Genome U74v2 annotation data (chip mgu74b)
...
%description
Affymetrix Murine Genome U74v2 annotation data (chip mgu74b) assembled
