...
Requires:         R-ape R-nloptr R-numDeriv R-SparseM R-corpcor R-lattice 


BuildRequires:    R-devel tex(latex) R-ape R-nloptr R-numDeriv R-SparseM R-corpcor R-lattice
...
models that allow the strength of selection and drift to vary across
selective regimes.
