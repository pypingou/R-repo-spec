...
Requires:         R-tools R-methods R-utils R-Biobase R-affy R-affydata 


BuildRequires:    R-devel tex(latex) R-tools R-methods R-utils R-Biobase R-affy R-affydata
