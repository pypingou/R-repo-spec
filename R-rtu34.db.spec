...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Affymetrix Rat Toxicology U34 Array annotation data (chip rtu34)
...
%description
Affymetrix Rat Toxicology U34 Array annotation data (chip rtu34) assembled
