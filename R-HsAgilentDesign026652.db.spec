%global packname  HsAgilentDesign026652.db
...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Agilent Chips that use Agilent design number 026652 annotation data (chip HsAgilentDesign026652)
...
HsAgilentDesign026652) assembled using data from public repositories
