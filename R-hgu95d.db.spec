...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Affymetrix Human Genome U95 Set annotation data (chip hgu95d)
...
%description
Affymetrix Human Genome U95 Set annotation data (chip hgu95d) assembled
