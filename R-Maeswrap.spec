...
Requires:         R-rgl R-lattice R-geometry 


BuildRequires:    R-devel tex(latex) R-rgl R-lattice R-geometry
...
%defattr(-, root, root, -)
%changelog
* Thu Dec 08 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 1.4.8-1
