...
Requires:         R-MASS R-glmnet R-ppls R-Epi R-GeneNet 


BuildRequires:    R-devel tex(latex) R-MASS R-glmnet R-ppls R-Epi R-GeneNet
...
%defattr(-, root, root, -)
%changelog
* Fri Dec 09 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 0.2.2-1
