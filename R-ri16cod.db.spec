...
Version:          2.11.0
Release:          1%{?dist}
Summary:          GE CodeLink Rat Inflammation 16 Bioarray annotation data (chip ri16cod)
...
%description
GE CodeLink Rat Inflammation 16 Bioarray annotation data (chip ri16cod)
