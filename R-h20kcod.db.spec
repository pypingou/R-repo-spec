...
Version:          2.11.0
Release:          1%{?dist}
Summary:          GE CodeLink UniSet Human 20k I Bioarray annotation data (chip h20kcod)
...
%description
GE CodeLink UniSet Human 20k I Bioarray annotation data (chip h20kcod)
