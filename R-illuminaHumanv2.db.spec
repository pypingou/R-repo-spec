%global packname  illuminaHumanv2.db
...
Version:          1.12.0
Release:          1%{?dist}
Summary:          Illumina HumanWG6v2 annotation data (chip illuminaHumanv2)
...
%description
Illumina HumanWG6v2 annotation data (chip illuminaHumanv2) assembled using
