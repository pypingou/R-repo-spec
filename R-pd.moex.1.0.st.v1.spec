%global packname  pd.moex.1.0.st.v1
...
Version:          3.2.0
Release:          1%{?dist}
Summary:          Platform Design Info for Affymetrix MoEx-1_0-st-v1
...
%defattr(-, root, root, -)
%changelog
* Sun Dec 11 2011 Pierre-Yves Chibon <pingou@pingoured.fr> 3.2.0-1
