...
Version:          2.6.1
Release:          1%{?dist}
Summary:          Homology information for Arabidopsis thaliana from Inparanoid
...
%description
Homology information for Arabidopsis thaliana from Inparanoid assembled
