...
Requires:         R-rgdal R-sp R-matrixStats 


BuildRequires:    R-devel tex(latex) R-rgdal R-sp R-matrixStats



%description
2dRUE is a methodology to make a diagnostic of land condition in a large
territory during a given time period. Was developed under the DeSurvey IP.
