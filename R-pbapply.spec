...
showing the progress is useful for the user (e.g. bootstrap).
...
%files
%defattr(-, root, root, -)
%doc %{rlibdir}/pbapply/DESCRIPTION
%doc %{rlibdir}/pbapply/COPYING
%doc %{rlibdir}/pbapply/html
%{rlibdir}/pbapply/ChangeLog
%{rlibdir}/pbapply/R
%{rlibdir}/pbapply/help
%{rlibdir}/pbapply/INDEX
%{rlibdir}/pbapply/NAMESPACE
%{rlibdir}/pbapply/Meta
