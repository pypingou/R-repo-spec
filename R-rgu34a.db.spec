...
Version:          2.6.3
Release:          1%{?dist}
Summary:          Affymetrix Rat Genome U34 Set annotation data (chip rgu34a)
...
%description
Affymetrix Rat Genome U34 Set annotation data (chip rgu34a) assembled
