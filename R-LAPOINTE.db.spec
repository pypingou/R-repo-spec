...
Version:          2.6.3
Release:          1%{?dist}
Summary:          A package containing metadata for LAPOINTE arrays
...
%description
A package containing metadata for LAPOINTE arrays assembled using data
