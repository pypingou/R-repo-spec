...
Requires:         R-methods R-MVCClass R-Biobase R-graph R-Rgraphviz 


BuildRequires:    R-devel tex(latex) R-methods R-MVCClass R-Biobase R-graph R-Rgraphviz
